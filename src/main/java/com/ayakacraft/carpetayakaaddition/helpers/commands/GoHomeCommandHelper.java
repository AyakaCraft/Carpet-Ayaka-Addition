...
package com.ayakacraft.carpetayakaaddition.helpers.commands;

import com.ayakacraft.carpetayakaaddition.mixin.commands.gohome.LivingEntityAccessor;
import net.minecraft.server.MinecraftServer;
import net.minecraft.server.network.ServerPlayerEntity;

public final class GoHomeCommandHelper {

    public static void sendHome(MinecraftServer server, ServerPlayerEntity player) {
        ServerPlayerEntity newPlayer = server.getPlayerManager().respawnPlayer(player,
                //#if MC>=11600
                //#else
